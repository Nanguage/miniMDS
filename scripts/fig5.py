...
#mMDS
coords1 = dt.structure_from_file("hic_data/GM12878_combined_22_10kb_mmds_rep1.tsv").getCoords()
coords2 = dt.structure_from_file("hic_data/GM12878_combined_22_10kb_mmds_rep2.tsv").getCoords()
#rs[1] = rep_correlation(coords1, coords2)
rs[0] = rep_correlation(coords1, coords2)

#miniMDS
coords1 = dt.structure_from_file("hic_data/GM12878_combined_22_10kb_minimds_rep1.tsv").getCoords()
coords2 = dt.structure_from_file("hic_data/GM12878_combined_22_10kb_minimds_rep2.tsv").getCoords()
